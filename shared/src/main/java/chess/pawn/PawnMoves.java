            ...
            // Basic Pawn movement
                ...
                if (column_l > 0) {
                    ...
                    if (enemy_l != null) {
                        if (selected_piece.getTeamColor() != enemy_l.getTeamColor()) {
                            if (row == 8) {
                                valid_moves.add(new ChessMove(piece_position, enemy_position_l, ChessPiece.PieceType.QUEEN));
                                valid_moves.add(new ChessMove(piece_position, enemy_position_l, ChessPiece.PieceType.BISHOP));
                                valid_moves.add(new ChessMove(piece_position, enemy_position_l, ChessPiece.PieceType.ROOK));
                                valid_moves.add(new ChessMove(piece_position, enemy_position_l, ChessPiece.PieceType.KNIGHT));
                            } else {
                                valid_moves.add(new ChessMove(piece_position, enemy_position_l, null));
                            }
                        }
                ...
                if (column_r < 9) {
                    ...
                    if (enemy_r != null) {
                        if (selected_piece.getTeamColor() != enemy_r.getTeamColor()) {
                            if (row == 8) {
                                valid_moves.add(new ChessMove(piece_position, enemy_position_r, ChessPiece.PieceType.QUEEN));
                                valid_moves.add(new ChessMove(piece_position, enemy_position_r, ChessPiece.PieceType.BISHOP));
                                valid_moves.add(new ChessMove(piece_position, enemy_position_r, ChessPiece.PieceType.ROOK));
                                valid_moves.add(new ChessMove(piece_position, enemy_position_r, ChessPiece.PieceType.KNIGHT));
                            } else {
                                valid_moves.add(new ChessMove(piece_position, enemy_position_r, null));
                            }
                        }
